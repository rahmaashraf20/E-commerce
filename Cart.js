      ...
      if (cart.length === 0) {
        ...
        cartItemsContainer.innerHTML = `
          ...
          <div class="bg-white rounded-3xl p-10 md:p-16 text-center">
            ...
            <a href="index.html"
               class="bg-black hover:bg-[#062b1f] text-white px-8 py-4 rounded-md uppercase tracking-widest text-xs transition-colors inline-block">
          ...
          <div class="bg-white rounded-3xl p-5 md:p-6">
            ...
            <div class="flex flex-col md:grid md:grid-cols-4 gap-6 items-center">
              ...
              <div class="flex gap-4 w-full">
                ...
                <img src="${item.image}"
                     class="w-24 h-28 rounded-xl object-cover"/>
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-500 uppercase mb-3">
